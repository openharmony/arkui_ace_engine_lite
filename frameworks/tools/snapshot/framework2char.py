...
def output_copyright(output):
    output.write("/*\n")
    output.write(" * Copyright (c) 2020-2023 Huawei Device Co., Ltd.\n")
...
def usage():
    ...
    print("  > use specific input path: "
          "python framework2char.py -b framework.min.bc -j framework.min.js")
